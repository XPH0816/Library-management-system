...
class Book_ManegementFrame:
    ...
    def show_data(self):
        ...
        self.heading.column("#0", width=5, minwidth=5, anchor=CENTER)
        self.heading.column("Column 2", width=90, minwidth=90, anchor=CENTER)
        self.heading.column("Column 3", width=2, minwidth=2, anchor=CENTER)
        self.heading.column("Column 4", width=2, minwidth=2, anchor=CENTER)
        ...
        self.heading.column("Column 7", width=30, minwidth=30, anchor=CENTER)
        self.heading.column("Column 8", width=30, minwidth=30, anchor=CENTER)
        self.heading.column("Column 9", width=50, minwidth=50, anchor=CENTER)
    ...
    def do_search_book(self):
        ...
        if self.var.get() == 2 :
            ...
            self.heading.column("Column 7", width=30, minwidth=30, anchor=CENTER)
            self.heading.column("Column 8", width=30, minwidth=30, anchor=CENTER)
            self.heading.column("Column 9", width=30, minwidth=30, anchor=CENTER)
